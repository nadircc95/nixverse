    ...
    <div class="row g-3">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" name="description" class="form-control" maxlength="100" id="exampleInputDescription"
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" name="value" class="form-control" maxlength="100" id="exampleInputValue"
                    placeholder="Enter value" required="">
                <div class="invalid-feedback">Please choose a value.</div>
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
