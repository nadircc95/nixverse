...
@section('modal_form')
<x-modal.modal-form id="modal_master" ::modal_class="modal-fullscreen " ::title="PMS" ::form="form_app" ::submit="1">
    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            ...
            <table id="table_master" class="table mb-0 fs--1" width="100%">
...
<x-modal.modal-blank ::id="modal_master_check" ::modal_class="modal-fullscreen " ::title="Dayly PB DewiVera">
...
{{-- <div class="row mt-5">
    <div class="col-lg-6 col-xl-12 col-xxl-6 h-100">
        ...
        <div class="card-body py-4">
            ...
            <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-tab2" id="bootstrap-wizard-tab2">
                <form>
                <div class="mb-3">
                    <div class="row" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"data":[{"name":"avatar.png","size":"54kb","url":"{{url('falcon')}}/assets/img/team"}]}'>
                    <div class="fallback">
                    ...
                    <div class="col-md-auto">
                        ...
                        <div class="dz-preview-cover d-flex align-items-center justify-content-center mb-3 mb-md-0">
                            <div class="avatar avatar-4xl"><img class="rounded-circle" src="{{url('falcon')}}/assets/img/team/avatar.png" alt="..." data-dz-thumbnail="data-dz-thumbnail" /></div>
                    ...
                    <div class="col-md">
                        ...
                        <div class="text-center"><img class="me-2" src="{{url('falcon')}}/assets/img/icons/cloud-upload.svg" width="25" alt="" />Upload your profile picture
            ...
            <div class="tab-pane text-center px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-tab4" id="bootstrap-wizard-tab4">
                ...
                <div class="lottie wizard-lottie mx-auto my-3" data-options='{"path":"{{url('falcon')}}/assets/img/animated-icons/celebration.json"}'></div>
                </div>
                <h4 class="mb-1">Your account is all set!</h4>
                <p>Now you can access to your account</p><a class="btn btn-primary px-5 my-3" href="{{url('falcon')}}/modules/forms/wizard.html">Start Over</a>
            </div>
            </div>
        </div>
    ...
    <div class="col-lg-6 col-xl-12 col-xxl-6 h-100">
        ...
        <div class="card-header bg-light pt-3 pb-2">
            <ul class="nav justify-content-between nav-wizard d-none">
    ...
    <div class="modal fade" id="error-modal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content position-relative p-5">
            ...
            <div class="lottie me-3" data-options='{"path":"{{url('falcon')}}/assets/img/animated-icons/warning-light.json"}'></div>
            <div class="flex-1">
          ...
          <div class="card-body py-3">
              <div class="d-flex flex-column">
                @foreach ($assets as $k => $v)
                    <button class="btn btn-outline-primary btn-lg me-1 mb-1" type="button" data-bs-toggle="modal" data-bs-target="#modal_master" data-ref-id="{{$v->id}}">
                    ...
                    <li class="treeview-list-item">
                        ...
                        <li class="treeview-list-item">
                            ...
                            <li class="treeview-list-item">
                                ...
                                <p class="treeview-text">
                                    Pembersihan Pada Bagian Compas<span class="badge rounded-pill badge-soft-primary ms-2">3</span>
                                </p>
                                </a>
...
{{-- <script src="{{url('falcon')}}/vendors/dropzone/dropzone.min.js"></script> --}}
<script src="{{url('falcon')}}/vendors/anchorjs/anchor.min.js"></script>
<script src="{{url('falcon')}}/vendors/is/is.min.js"></script>
{{-- <script src="{{url('falcon')}}/assets/js/flatpickr.js"></script>
<script src="{{url('falcon')}}/vendors/dropzone/dropzone.min.js"></script> --}}
...
<script>
    ...
    $(async function(){
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta){
                        let _html = `
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="flexRadioDefault1-${row.id}" name="flexRadioDefault-${row.id}" checked=""/>
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta){
                        let _html = `
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="flexRadioDefault2-${row.id}" name="flexRadioDefault-${row.id}" />
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta){
                        let _html = `
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="flexRadioDefault3-${row.id}" name="flexRadioDefault-${row.id}" />
        ...
        $(`#modal_master`).find(`#btn_refresh`).on('click', function(){
